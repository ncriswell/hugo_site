...
mu_out <- F_get_weekly_matchup(season = 2019, week = 1:13)
mu_view0 <- mu_out$mu_view0

stat_out <- F_get_weekly_player_stats(season = 2019, week = 1:13)
...
trans_res <- lapply(1:13, function(m) fromJSON(glue("https://api.sleeper.app/v1/league/", 
                           lg_id, 
                           "/transactions/", m))) 
