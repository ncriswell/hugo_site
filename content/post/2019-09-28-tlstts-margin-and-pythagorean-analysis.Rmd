...
From this we see that margin of victory continues to be pretty high with a couple of real nail-biters spinkled in here and there. A view of this for all seasons (Season 2019 through three week) can be seen below. 
...
Please note, we are forcing that line through 0 as the intercept. Oh also, we can't have 0s since we taking logs here so we're dropping 2019. Whats that? You quit reading several sections ago? Fantastic. Anyways, I am about 20 minutes over budget on the time I was going to bury into this today and so I'm just going to bring the regression summary which gives us the slope of the line as the coefficient on `lgwl`. 
